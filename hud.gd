...
func _on_bullet_damage_button_pressed() -> void:
	if PlayerVariables.upgradable.kills >= ShopVariables.PRICES.bullet_damage:
		PlayerVariables.upgradable.kills -= ShopVariables.PRICES.bullet_damage;
...
func _on_movement_speed_button_pressed() -> void:
	if PlayerVariables.upgradable.kills >= ShopVariables.PRICES.movement_speed:
		PlayerVariables.upgradable.kills -= ShopVariables.PRICES.movement_speed;
...
func _on_shooting_speed_button_pressed() -> void:
	if PlayerVariables.upgradable.kills >= ShopVariables.PRICES.shooting_speed:
		PlayerVariables.upgradable.kills -= ShopVariables.PRICES.shooting_speed;
...
func _on_enemy_spawn_rate_button_pressed() -> void:
	if PlayerVariables.upgradable.kills >= ShopVariables.PRICES.enemy_spawn_rate:
		PlayerVariables.upgradable.kills -= ShopVariables.PRICES.enemy_spawn_rate;
